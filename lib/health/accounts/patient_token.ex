defmodule Health.Accounts.PatientToken do
  ...
  Therefore, storing them allows individual patient
  ...
  The query returns the patient found by the token, if any.
  ...
  @doc """
  Builds a token and its hash to be delivered to the patient's email.

  The non-hashed token is sent to the patient email while the
  ...
  This is used to validate requests to change the patient
  ...
  @doc """
  Gets all tokens for the given patient for the given contexts.
  """
